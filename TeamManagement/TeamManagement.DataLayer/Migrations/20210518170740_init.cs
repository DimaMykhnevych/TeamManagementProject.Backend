        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfPublishing = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    PublisherId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HowToArticles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HowToArticles_AspNetUsers_PublisherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CountOfPeopleVoted = table.Column<int>(type: "int", nullable: false),
                    DoesAllowMultiple = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HowToArticles_Name",
                table: "HowToArticles",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_HowToArticles_PublisherId",
                table: "HowToArticles",
                column: "PublisherId");
